...
<head>
    ...
    <title>Chỉnh sửa thông tin nhà cung cấp sản phẩm</title>
    <!-- ======= Styles ====== -->
    ...
    <jsp:include page="admin_menu.jsp" /> 
        ...
        <div class="main">
			...
			<div class="addproduct_catedory"> <!-- đặt nó ở trong form rồi thêm loại sản phẩm cho nó mà tôi -->
				<h2>Chỉnh sửa thông tin nhà cung cấp sản phẩm</h2>
				...
				<form action="ProviderServlet" method="post">
					<div class="container-input" style="text-align: left;padding-left: 150px;">
						<div class="item-input" style="display: flex;padding-right: 265px;margin-bottom: 10px;margin-top: 10px;">
							<label style="flex: 0.4;align-self: center;font-size: 23px;">Tên nhà cung cấp</label>
							<input type="text" name="nameprovider" style="flex: 1;" value="${provider.nameProvider }" required placeholder="Tên sản phẩm" class="name_cate" >
						</div>
						<div class="item-input" style="display: flex;padding-right: 265px;margin-bottom: 10px;margin-top: 10px;">
