...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="HomeServlet">Trang chủ</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Đơn hàng</strong></div>
        </div>
      </div>
    </div>
              ...
              <!-- Titile -->
                <thead>
                  <tr>
                    ...
                    <th class="product-price">Tổng đơn hàng</th>
                    <th>Chi tiết</th>
                  </tr>
                </thead>
                <tbody>
		        ...
		        <c:forEach var="item" items="${orders}">
                    ...
                    <td class="product-name">
                      ...
                      <h2 class="h5 text-black">${item.dateShip}</h2>
	                 ...
	                 <td> 
	                 	<form action="OrderdetailServlet" method="post">
								...
								<input type="hidden" name="idorder" value="${item.orderId }">     		
		                   		<input class="btn btn-primary btn-sm" type="submit" value="Chi tiết đơn hàng" >
	                 	</form>
